...
{
    _COM_ASSERT(s == NULL || (const char*) *this != s);
...
{
    _COM_ASSERT(s == NULL || (const wchar_t*) *this != s);
...
{
    _COM_ASSERT((BSTR) bstrSrc == NULL || V_BSTR(this) != (BSTR) bstrSrc);
...
{
    _COM_ASSERT(pSrc == NULL || V_BSTR(this) != pSrc);
...
{
    _COM_ASSERT(pSrc == NULL || V_I1REF(this) != pSrc);
...
{
    _COM_ASSERT(pSrc == 0 || V_DISPATCH(this) != pSrc);
...
{
    _COM_ASSERT(pSrc == NULL || V_UNKNOWN(this) != pSrc);
