        ...
        if(hDC = GetDC(hWnd))
        {
            ...
            if(hBrush = SelectObject(hDC,CreateSolidBrush(RGB(r,g,b))))
            {
                ...
                switch(nObject)
                {
                    default:
                    case OBJ_RECTANGLE:
                        _snprintf(szDebug,sizeof(szDebug)-1,"Rectangle(%d,%d,%d,%d)\n",x1,y1,x2,y2);
                    ...
                    case OBJ_ELLIPSE:
                        _snprintf(szDebug,sizeof(szDebug)-1,"Ellipse(%d,%d,%d,%d)\n",x1,y1,x2,y2);
                        szDebug[sizeof(szDebug)-1] = '\0';
                    ...
                    case OBJ_ROUNDRECT:
                        _snprintf(szDebug,sizeof(szDebug)-1,"RoundRect(%d,%d,%d,%d,%d,%d)\n",x1,y1,x2,y2,x3,y3);
                        szDebug[sizeof(szDebug)-1] = '\0';
                    ...
                    case OBJ_CHORD:
                        _snprintf(szDebug,sizeof(szDebug)-1,"Chord(%d,%d,%d,%d,%d,%d,%d,%d)\n",x1,y1,x2,y2,x3,y3,x4,y4);
                        szDebug[sizeof(szDebug)-1] = '\0';
                    ...
                    case OBJ_PIE:
                        _snprintf(szDebug,sizeof(szDebug)-1,"Pie(%d,%d,%d,%d,%d,%d,%d,%d)\n",x1,y1,x2,y2,x3,y3,x4,y4);
                        szDebug[sizeof(szDebug)-1] = '\0';
