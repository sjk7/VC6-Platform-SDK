...
/** @com.class(classid=00000535-0000-0010-8000-00AA006D2EA4,DynamicCasts) 
    @com.interface(iid=00000556-0000-0010-8000-00AA006D2EA4, thread=AUTO, type=DUAL) */
public class Recordset implements IUnknown,com.ms.com.NoAutoScripting,msado15._Recordset
{
  ...
  public native int getAbsolutePosition();
  ...
  public native void setAbsolutePosition(int pl);
  ...
  public native void setActiveConnection(Object pvar);
  ...
  public native void setActiveConnection(Variant pvar);
  ...
  public native void setBookmark(Variant pvBookmark);
  ...
  public native void setMaxRecords(int plMaxRecords);
  ...
  public native void setSource(Object pvSource);
  ...
  public native void AddNew(Variant FieldList, Variant Values);
  ...
  public native void Delete(int AffectRecords);
  ...
  public native Variant GetRows(int Rows, Variant Start, Variant Fields);
  ...
  public native void Move(int NumRecords, Variant Start);
  ...
  public native void setFilter(Variant Criteria);
  ...
  /** @com.method(vtoffset=48, dispid=1048, type=PROPPUT, name="PageSize", name2="putPageSize", addFlagsVtable=4)
      @com.parameters([in,type=I4] pl) */
  public native void setPageSize(int pl);
  ...
  public native void setSort(String Criteria);
  ...
  public native void setCursorLocation(int plCursorLoc);
  ...
  public native msado15._Recordset NextRecordset(Variant RecordsAffected);
  ...
  public native boolean Supports(int CursorOptions);
  ...
  /** @com.method(vtoffset=60, dispid=4294967288, type=PROPGET, name="Collect", name2="getCollect", addFlagsVtable=4)
      ...
      @hidden */
  public native Variant getCollect(Variant Index);
  ...
  public native void setMarshalOptions(int peMarshal);
  ...
  public native void Find(String Criteria, int SkipRecords, int SearchDirection, Variant Start);
  ...
  public native IUnknown getDataSource();
  ...
  public native void setDataSource(IUnknown ppunkDataSource);
  ...
  /** @com.method(vtoffset=68, dispid=1610874883, type=METHOD, name="_xSave", addFlagsVtable=4)
      ...
      @hidden */
  public native void _xSave(String FileName, int PersistFormat);
  ...
  public native Object getActiveCommand();
  ...
  public native String GetString(int StringFormat, int NumRows, String ColumnDelimeter, String RowDelimeter, String NullExpr);

  /** @com.method(vtoffset=73, dispid=1064, type=PROPGET, name="DataMember", name2="getDataMember", addFlagsVtable=4)
      @com.parameters([type=STRING] return) */
  public native String getDataMember();
  ...
  public native void setDataMember(String pbstrDataMember);
  ...
  public native int CompareBookmarks(Variant Bookmark1, Variant Bookmark2);
  ...
  public native msado15._Recordset Clone(int LockType);
  ...
  public native void Resync(int AffectRecords, int ResyncValues);
  ...
  public native void Seek(Variant KeyValues, int SeekOption);
  ...
  public native void setIndex(String pbstrIndex);

  /** @com.method(vtoffset=80, dispid=1067, type=PROPGET, name="Index", name2="getIndex", addFlagsVtable=4)
      @com.parameters([type=STRING] return) */
  public native String getIndex();

  /** @com.method(vtoffset=81, dispid=1057, type=METHOD, name="Save", addFlagsVtable=4)
      @com.parameters([in,type=VARIANT] Destination, [in,type=I4] PersistFormat) */
  public native void Save(Variant Destination, int PersistFormat);


  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0x556, (short)0x0, (short)0x10, (byte)0x80, (byte)0x0, (byte)0x0, (byte)0xaa, (byte)0x0, (byte)0x6d, (byte)0x2e, (byte)0xa4);

  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x535, (short)0x0, (short)0x10, (byte)0x80, (byte)0x0, (byte)0x0, (byte)0xaa, (byte)0x0, (byte)0x6d, (byte)0x2e, (byte)0xa4);
}
