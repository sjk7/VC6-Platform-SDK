...
/** @com.class(classid=00000560-0000-0010-8000-00AA006D2EA4,DynamicCasts) 
    @com.interface(iid=00000562-0000-0010-8000-00AA006D2EA4, thread=AUTO, type=DUAL) */
public class Record implements IUnknown,com.ms.com.NoAutoScripting,msado15._Record
{
  ...
  public native void setActiveConnection(String pvar);
  ...
  public native void setActiveConnection(msado15._Connection pvar);
  ...
  /** @com.method(vtoffset=10, dispid=3, type=PROPPUT, name="Source", name2="putSource", addFlagsVtable=4)
      @com.parameters([in,type=STRING] pvar) */
  public native void setSource(String pvar);
  ...
  public native void setSource(Object pvar);
  ...
  public native String MoveRecord(String Source, String Destination, String UserName, String Password, int Options, boolean Async);

  /** @com.method(vtoffset=16, dispid=7, type=METHOD, name="CopyRecord", addFlagsVtable=4)
      @com.parameters([in,type=STRING] Source, [in,type=STRING] Destination, [in,type=STRING] UserName, [in,type=STRING] Password, [in,type=I4] Options, [in,type=BOOLEAN] Async, [type=STRING] return) */
  public native String CopyRecord(String Source, String Destination, String UserName, String Password, int Options, boolean Async);
  ...
  public native void DeleteRecord(String Source, boolean Async);
  ...
  public native void Open(Variant Source, Variant ActiveConnection, int Mode, int CreateOptions, int Options, String UserName, String Password);
  ...
  public native msado15._Recordset GetChildren();
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x560, (short)0x0, (short)0x10, (byte)0x80, (byte)0x0, (byte)0x0, (byte)0xaa, (byte)0x0, (byte)0x6d, (byte)0x2e, (byte)0xa4);
}
