...
/** @com.interface(iid=0000050D-0000-0010-8000-00AA006D2EA4, thread=AUTO, type=DUAL) */
public interface Parameters extends msado15._DynaCollection
{
  ...
  /** @com.method(vtoffset=9, dispid=0, type=PROPGET, name="Item", name2="getItem", addFlagsVtable=4)
      @com.parameters([in,type=VARIANT] Index, [iid=0000050C-0000-0010-8000-00AA006D2EA4,thread=AUTO,type=DISPATCH] return) */
  public msado15._Parameter getItem(Variant Index);


  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0x50d, (short)0x0, (short)0x10, (byte)0x80, (byte)0x0, (byte)0x0, (byte)0xaa, (byte)0x0, (byte)0x6d, (byte)0x2e, (byte)0xa4);
}
