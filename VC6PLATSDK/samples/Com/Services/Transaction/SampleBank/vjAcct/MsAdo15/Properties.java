...
/** @com.interface(iid=00000504-0000-0010-8000-00AA006D2EA4, thread=AUTO, type=DUAL) */
public interface Properties extends msado15._Collection
{
  ...
  /** @com.method(vtoffset=7, dispid=0, type=PROPGET, name="Item", name2="getItem", addFlagsVtable=4)
      @com.parameters([in,type=VARIANT] Index, [iid=00000503-0000-0010-8000-00AA006D2EA4,thread=AUTO,type=DISPATCH] return) */
  public msado15.Property getItem(Variant Index);


  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0x504, (short)0x0, (short)0x10, (byte)0x80, (byte)0x0, (byte)0x0, (byte)0xaa, (byte)0x0, (byte)0x6d, (byte)0x2e, (byte)0xa4);
}
