...
/** @com.class(classid=00000566-0000-0010-8000-00AA006D2EA4,DynamicCasts) 
    @com.interface(iid=00000565-0000-0010-8000-00AA006D2EA4, thread=AUTO, type=DUAL) */
public class Stream implements IUnknown,com.ms.com.NoAutoScripting,msado15._Stream
{
  ...
  public native void setPosition(int pPos);
  ...
  public native void setLineSeparator(int pLS);
  ...
  public native void setCharset(String pbstrCharset);
  ...
  public native Variant Read(int NumBytes);
  ...
  public native void Open(Variant Source, int Mode, int Options, String UserName, String Password);
  ...
  public native void CopyTo(msado15._Stream DestStream, int CharNumber);
  ...
  public native void SaveToFile(String FileName, int Options);
  ...
  public native String ReadText(int NumChars);
  ...
  public native void WriteText(String Data, int Options);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x566, (short)0x0, (short)0x10, (byte)0x80, (byte)0x0, (byte)0x0, (byte)0xaa, (byte)0x0, (byte)0x6d, (byte)0x2e, (byte)0xa4);
}
