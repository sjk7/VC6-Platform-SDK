...
/** @com.interface(iid=00000501-0000-0010-8000-00AA006D2EA4, thread=AUTO, type=DUAL) */
public interface Errors extends msado15._Collection
{
  ...
  /** @com.method(vtoffset=7, dispid=0, type=PROPGET, name="Item", name2="getItem", addFlagsVtable=4)
      @com.parameters([in,type=VARIANT] Index, [iid=00000500-0000-0010-8000-00AA006D2EA4,thread=AUTO,type=DISPATCH] return) */
  public msado15.Error getItem(Variant Index);

  /** @com.method(vtoffset=8, dispid=1610809345, type=METHOD, name="Clear", addFlagsVtable=4)
      @com.parameters() */
  public void Clear();


  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0x501, (short)0x0, (short)0x10, (byte)0x80, (byte)0x0, (byte)0x0, (byte)0xaa, (byte)0x0, (byte)0x6d, (byte)0x2e, (byte)0xa4);
}
