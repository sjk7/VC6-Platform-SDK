...
/** @com.class(classid=00000514-0000-0010-8000-00AA006D2EA4,DynamicCasts) 
    @com.interface(iid=00000550-0000-0010-8000-00AA006D2EA4, thread=AUTO, type=DUAL) */
public class Connection implements IUnknown,com.ms.com.NoAutoScripting,msado15._Connection
{
  ...
  public native void setConnectionString(String pbstr);
  ...
  public native void setCommandTimeout(int plTimeout);
  ...
  /** @com.method(vtoffset=10, dispid=3, type=PROPPUT, name="ConnectionTimeout", name2="putConnectionTimeout", addFlagsVtable=4)
      @com.parameters([in,type=I4] plTimeout) */
  public native void setConnectionTimeout(int plTimeout);
  ...
  public native void Open(String ConnectionString, String UserID, String Password, int Options);
  ...
  public native void setIsolationLevel(int Level);
  ...
  public native void setAttributes(int plAttr);
  ...
  public native void setMode(int plMode);
  ...
  /** @com.method(vtoffset=30, dispid=17, type=PROPPUT, name="Provider", name2="putProvider", addFlagsVtable=4)
      @com.parameters([in,type=STRING] pbstr) */
  public native void setProvider(String pbstr);
  ...
  public native msado15._Recordset OpenSchema(int Schema, Variant Restrictions, Variant SchemaID);

  /** @com.method(vtoffset=33, dispid=21, type=METHOD, name="Cancel", addFlagsVtable=4)
      @com.parameters() */
  public native void Cancel();


  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0x550, (short)0x0, (short)0x10, (byte)0x80, (byte)0x0, (byte)0x0, (byte)0xaa, (byte)0x0, (byte)0x6d, (byte)0x2e, (byte)0xa4);

  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x514, (short)0x0, (short)0x10, (byte)0x80, (byte)0x0, (byte)0x0, (byte)0xaa, (byte)0x0, (byte)0x6d, (byte)0x2e, (byte)0xa4);
}
