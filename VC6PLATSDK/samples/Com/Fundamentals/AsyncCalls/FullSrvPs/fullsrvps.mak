...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib uuid.lib odbc32.lib odbccp32.lib rpcrt4.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\FullSrvps.pdb" /machine:$(CPU) /def:".\FullSvrps.def" /out:"$(OUTDIR)\FullSrvps.dll" /implib:"$(OUTDIR)\FullSrvps.lib" 
DEF_FILE= \
	".\FullSvrps.def"
LINK32_OBJS= \
	"$(INTDIR)\dlldata.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib uuid.lib odbc32.lib odbccp32.lib rpcrt4.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\FullSrvps.pdb" /debug /machine:$(CPU) /def:".\FullSvrps.def" /out:"$(OUTDIR)\FullSrvps.dll" /implib:"$(OUTDIR)\FullSrvps.lib" /pdbtype:sept 
DEF_FILE= \
	".\FullSvrps.def"
LINK32_OBJS= \
	"$(INTDIR)\dlldata.obj" \
