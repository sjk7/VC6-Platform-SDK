...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\FullSvr.pdb" /debug /machine:$(CPU) /out:"$(OUTDIR)\FullSvr.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\FullServ.obj" \
	"$(INTDIR)\FullSvr.obj" \
	"$(INTDIR)\StdAfx.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\FullSvr.pdb" /debug /machine:$(CPU) /out:"$(OUTDIR)\FullSvr.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\FullServ.obj" \
	"$(INTDIR)\FullSvr.obj" \
	"$(INTDIR)\StdAfx.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\FullSvr.pdb" /machine:$(CPU) /out:"$(OUTDIR)\FullSvr.exe" 
LINK32_OBJS= \
	"$(INTDIR)\FullServ.obj" \
	"$(INTDIR)\FullSvr.obj" \
	"$(INTDIR)\StdAfx.obj" \
