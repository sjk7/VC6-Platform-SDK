...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\dog.pdb" /debug /machine:$(CPU) /out:"$(OUTDIR)\dog.dll" /implib:"$(OUTDIR)\dog.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dog.obj" \
	"$(INTDIR)\dogcf.obj" \
	"$(INTDIR)\idog.obj" \
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\dog.pdb" /machine:$(CPU) /out:"$(OUTDIR)\dog.dll" /implib:"$(OUTDIR)\dog.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dog.obj" \
	"$(INTDIR)\dogcf.obj" \
	"$(INTDIR)\idog.obj" \
