...
# ADD CPP /nologo /Gz /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_WIN32_DCOM" /D "_UNICODE" /D "UNICODE" /YX /FD /c
...
TargetPath=\mssdk\Samples\COM\Fundamentals\DCOM\Simple\bin\Release\x86\sserver.exe
TargetName=sserver
InputPath=\mssdk\Samples\COM\Fundamentals\DCOM\Simple\bin\Release\x86\sserver.exe
SOURCE="$(InputPath)"

"$(OutDir)\$(TargetName).reg" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
...
# ADD CPP /nologo /Gz /W3 /Gm /GX /ZI /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_WIN32_DCOM" /D "_UNICODE" /D "UNICODE" /YX /FD /GZ /c
...
TargetPath=\mssdk\Samples\COM\Fundamentals\DCOM\Simple\bin\Debug\x86\sserver.exe
TargetName=sserver
InputPath=\mssdk\Samples\COM\Fundamentals\DCOM\Simple\bin\Debug\x86\sserver.exe
SOURCE="$(InputPath)"
