...
)
{
    ...
    else
    {
        ...
        // window's user data
        me = (CRTCIMSession *)GetWindowLong(hWnd, GWL_USERDATA);
...
LRESULT CRTCIMSession::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam)    
{
    ...
    m_wpOrigEditProc = (WNDPROC)SetWindowLong(m_hEdit,
        GWL_WNDPROC, (LONG)CRTCIMSession::EditSubclassProc);
...
{ 
    ...
    SetWindowLong(m_hEdit, GWL_WNDPROC, (LONG)m_wpOrigEditProc);
