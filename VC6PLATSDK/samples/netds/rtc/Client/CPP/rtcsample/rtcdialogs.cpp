...
{
    LOGON_DATA *pLD;
    pLD = (LOGON_DATA *)GetWindowLong(hwndDlg, DWL_USER);
...
{
    AUTH_DATA *pAD;
    pAD = (AUTH_DATA *)GetWindowLong(hwndDlg, DWL_USER);
...
{
    WATCHER_DATA *pWD;
    pWD = (WATCHER_DATA *)GetWindowLong(hwndDlg, DWL_USER);
...
{
    ADDRESS_DATA *pAD;
    pAD = (ADDRESS_DATA *)GetWindowLong(hwndDlg, DWL_USER);
...
{
    SESSION_DATA *pSD;
    pSD = (SESSION_DATA *)GetWindowLong(hwndDlg, DWL_USER);
