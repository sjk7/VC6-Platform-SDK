...
#ifdef _IA64_
#pragma warning(disable: 4127 4244 4327 4267)
#endif
    ...
    )
{
    ...
    v4hdr->ip_tos         = 0;
    v4hdr->ip_totallength = htons((u_short) (sizeof(IPV4_HDR) + payloadlen));
    v4hdr->ip_id          = 0;
    v4hdr->ip_offset      = 0;
    ...
    )
{
    ...
    udphdr->udp_length = htons((u_short) (sizeof(UDP_HDR) + payloadlen));
...
int _cdecl main(int argc, char **argv)
{
    ...
    if (gSender)
    {
        ...
        PrintAddress(resdest->ai_addr, resdest->ai_addrlen);
        printf("\n");
